...
// Horizontal Notes Section for Desktop
export const HorizontalNotesSection = React.memo(
...
// Vertical Notes Section for Mobile
export const VerticalNotesSection = React.memo(
